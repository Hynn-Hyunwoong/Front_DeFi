...
export const TopicDefine = () => {
    ...
    return(
        <>
                ...
                <Topicspan>- 제출된 제안은 수정 또는 취소할 수 업습니다. 최종 제출 전 신중하게 제출해주세요.</Topicspan>
                <Topicspan>- 제안 등록 시점 기준 Protocol 에서 발행된 토큰을 소유한 사용자만 제출을 완료할 수 있습니다.</Topicspan>
                ...
                <Topicspan>    1. 총 투표자가 최소 참여 기준 이상인 경우 ** 투표 참여기준은 투표 시작시점에 총 GovToken의 51% 이상</Topicspan>
                <Topicspan>    2. 총 투표자의 과반수 이상이 찬성하는 경우</Topicspan>
                <Topicspan>- B. 부결 기준</Topicspan>
                <Topicspan>    1. 투표기간(2일) 종료까지 최소 참여 투표미만으로 참여된 경우 </Topicspan>
